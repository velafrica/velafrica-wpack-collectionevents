...
module.exports = {
	// Project Identity
	appName: 'velafricaCollectionevents', // Unique name of your project
	type: 'plugin', // Plugin or theme
	slug: 'velafrica-collectionevents', // Plugin or Theme slug, basically the directory name under `wp-content/<themes|plugins>`
	// Used to generate banners on top of compiled stuff
	bannerConfig: {
		name: 'velafricaCollectionevents',
		author: '',
		license: 'UNLICENSED',
		link: 'UNLICENSED',
		version: pkg.version,
